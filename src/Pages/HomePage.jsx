  ...
  return (
    <>
      ...
      <section className="bg-slate-100 box-border h-max py-2 ">
        <div
          className="flex py-4 md:mx-[5rem] 2xl:mx-[10rem] mx-[1rem] overflow-x-auto no-scrollbar space-x-7 "
          ref={sliderRef}
        >
          {StackData.map((stack) => (
      ...
      >
        <p className="md:w-[68%]  font-semibold text-xl md:text-2xl text-slate-500">
          Are you looking for a gaming app agency ? Trust our talented team of
          designers and developers to get high-quality 2D and 3D games.
        </p>
        <a href="#form-section">
      ...
      <section id="games-project-section" className="my-[5rem] 2xl:mx-[6rem]  ">
        <div className="md:mx-16 md:space-y-10  md:text-start text-center space-y-4">
          ...
          <p className=" md:w-[70%] font-medium text-xl text-slate-600 leading-9  ">
            Keeping up with the latest techs and innovations is necessary
            htmlFor gamers and game development experts alike. From Augmented
            Reality and Virtual Reality to cross-platform play and mobile
            gaming, there’s a lot to look forward to as the gaming industry
            reaches new heights.{" "}
          </p>
        </div>
